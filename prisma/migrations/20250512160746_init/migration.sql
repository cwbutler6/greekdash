...
-- CreateIndex
CREATE INDEX "Membership_chapterId_idx" ON "Membership"("chapterId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Subscription_chapterId_key" ON "Subscription"("chapterId");
...
-- AddForeignKey
ALTER TABLE "Subscription" ADD CONSTRAINT "Subscription_chapterId_fkey" FOREIGN KEY ("chapterId") REFERENCES "Chapter"("id") ON DELETE CASCADE ON UPDATE CASCADE;
