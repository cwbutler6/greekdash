        ...
        <CardContent>
          ...
          <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="create" className="space-y-4 mt-4">
              ...
              {/* Google Sign-in Button for Create Chapter */}
              {!isGoogleUser && (
                <div className="space-y-4">
                  <Button
                    ...
                    variant="outline"
                    className="w-full"
                    onClick={() => signIn('google', { callbackUrl: '/signup?tab=create&google=true' })}
                    disabled={isLoading}
                  >
            ...
            <TabsContent value="join" className="space-y-4 mt-4">
              ...
              {/* Google Sign-in Button for Join Chapter */}
              {!isGoogleUser && (
                <div className="space-y-4">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full"
                    onClick={() => signIn('google', { callbackUrl: '/signup?tab=join&google=true' })}
                    disabled={isLoading}
                  >
                    <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
